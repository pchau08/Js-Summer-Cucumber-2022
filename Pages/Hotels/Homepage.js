...
class Homepage {
    ...
    learnAboutHotelRewards = "//a[contains(text(),'Learn about Hotels.com Rewards')]";

    rewardsJoinNowButton = "//a[contains(text(),'Join Now')]";

    createAccountEmailAddress = '#signupFormEmailInput';

    createAccountFirstName = '#signupFormFirstNameInput';

    createAccountLastName = '#signupFormLastNameInput';

    createAccountPassword = '#signupFormPasswordInput';

    continueButton = '#signupFormSubmitButton';
    ...
    async clickOnHotelRewards() {
        await this.commands.clickWebElement(this.learnAboutHotelRewards);
    }

    async clickOnJoinNow() {
        await this.commands.clickWebElement(this.rewardsJoinNowButton);
    }

    async createAccountForm() {
        await this.commands.isWebElementDisplayedWithWait(this.createAccountEmailAddress);
        await this.commands.isWebElementDisplayedWithWait(this.createAccountFirstName);
        await this.commands.isWebElementDisplayedWithWait(this.createAccountForm);
        await this.commands.isWebElementDisplayedWithWait(this.createAccountPassword);
    }

    async continueButtonVerification() {
        await this.commands.isWebElementEnabled(this.continueButton);
    }
